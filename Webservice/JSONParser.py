...
name = raw_input("Enter a food name: ")
url = "http://api.data.gov/usda/ndb/search/?format=json&q=" + name + "&max=25&offset=0&api_key=3hVnhFvj1VAagD29p9Q5b5MeYenARhmAvyX2suCf"
